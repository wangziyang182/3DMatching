...
class dataset(object):
    ...
    def x_y_split(self,random_seed = 0):
        ...
        self._obj_ply_list_train,\
        self._obj_ply_list_test,\
        self._correspondence_list_train,\
        self._correspondence_list_test = train_test_split(self._obj_ply, self._correspondence_list, test_size=0.33, random_state=random_seed)
    ...
    def generate_train_data_batch(self,num_match, num_non_match,batch_size = 1,Non_Match_Distance_Clip = 3):
        ...
        ply =  self._obj_ply_list_train[self._pointer_start:self._pointer_end]
        ...
        return volume_object,volume_package,match,non_match,ply
    ...
    def generate_test_data_batch(self,batch_size = 1):
        ...
        ply =  self._obj_ply_list_test[self._pointer_start:self._pointer_end]
        ...
        return volume_object,volume_package,match,ply
    ...
    def generate_non_matches(self,match,Non_Match_Distance_Clip = 3):
        ...
        for i,batch in enumerate(match):
            ...
            while flag:
                ...
                non_match_ele = np.concatenate([x,y,z],axis = 1)
...
if __name__ == '__main__':
    ...
    data.generate_test_data_batch(2)
    print(data._vol_dim)
    print(data._tsdf_volume_list_test)